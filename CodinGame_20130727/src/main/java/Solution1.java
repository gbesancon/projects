...
public class Solution1 {
  ...
  private static List<List<Integer>> performInfluenceChains(
  ...
  private static List<List<Integer>> performInfluenceChains(
      Map<Integer, List<Integer>> relationships, List<Integer> precedingInfluenceChain) {
    List<List<Integer>> influenceChains = new ArrayList<List<Integer>>();
    List<Integer> relateds =
        relationships.get(precedingInfluenceChain.get(precedingInfluenceChain.size() - 1));
    if (relateds != null) {
