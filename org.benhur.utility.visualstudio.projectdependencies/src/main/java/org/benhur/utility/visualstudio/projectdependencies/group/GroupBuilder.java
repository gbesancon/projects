...
public class GroupBuilder
{
  ...
  protected Group getGroup(int[] ids, Configuration configuration)
  {
    ...
    try
    {
      ...
      {
        String groupProjectNameIncludePatternString = configuration.getGroupProjectNameIncludePattern(ids);
        String groupProjectNameExcludePatternString = configuration.getGroupProjectNameExcludePattern(ids);
  ...
  {
    for (ISolutionItem solutionItem : SolutionUtility.getAlphabeticallyOrderedSolutionItems(solution))
    {
