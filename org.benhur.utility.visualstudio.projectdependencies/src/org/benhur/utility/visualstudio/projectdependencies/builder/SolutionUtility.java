...
public class SolutionUtility
{
  ...
  public static List<ISolutionItem> getAlphabeticallyOrderedSolutionItems(ISolution solution)
  {
    ...
    Collections.sort(solutionItems, new Comparator<ISolutionItem>()
    {
      @Override
  ...
  protected static void populateSolutionItemsById(Map<String, ISolutionItem> solutionItemByIds, ISolution solution)
  {
  ...
  protected static void populateSolutionItemsById(Map<String, ISolutionItem> solutionItemByIds,
