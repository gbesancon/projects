...
public class Solution1 {
  ...
  public static Direction[] normal_directions_order = {
    Direction.SOUTH, Direction.EAST, Direction.NORTH, Direction.WEST
  };
  public static Direction[] inversed_directions_order = {
    ...
    if (!journey.isEndOfJourney) {
      ...
      if (!foundValidDirection) {
        Direction[] direction_order =
            journey.isInverse ? inversed_directions_order : normal_directions_order;
        for (int iDirection = 0;
            iDirection < direction_order.length && !foundValidDirection;
            iDirection++) {
