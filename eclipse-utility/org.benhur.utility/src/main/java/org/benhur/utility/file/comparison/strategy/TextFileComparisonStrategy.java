...
public class TextFileComparisonStrategy implements FileComparisonStrategy {
        ...
        try {
          ...
          do {
            ...
            while (offset1 < BUFFER_SIZE
                && (read1 = inputStream1.read(buffer1, offset1, BUFFER_SIZE - offset1)) >= 0) {
              offset1 += read1;
            }
            int offset2 = 0;
            while (offset2 < BUFFER_SIZE
                && (read2 = inputStream2.read(buffer2, offset2, BUFFER_SIZE - offset2)) >= 0) {
              offset2 += read2;
            }
            // Check offsets
            if (offset1 == offset2) {
