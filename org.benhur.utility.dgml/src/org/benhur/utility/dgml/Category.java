...
public class Category
{
  ...
  public Category(String id, String label, String description, boolean canBeDataDriven,
                  boolean canLinkedNodesBeDataDriven, String incomingActionLabel, boolean isContainment,
