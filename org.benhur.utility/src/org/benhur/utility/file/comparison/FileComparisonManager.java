...
import org.benhur.utility.file.comparison.strategy.IFileComparisonStrategy;
import org.benhur.utility.file.comparison.strategy.TextFileComparisonStrategy;

public class FileComparisonManager
{
  protected IFileComparisonStrategy defaultFileComparisonStrategy = null;
  ...
  public void setDefaultFileComparisonStrategy(IFileComparisonStrategy defaultFileComparisonStrategy)
  {
  ...
  public void addFileComparisonStrategy(FileFilter fileFilter, IFileComparisonStrategy fileComparisonStrategy)
  {
    fileComparisonStrategies.put(fileFilter, fileComparisonStrategy);
  }

  public IFileComparisonStrategy getFileComparisonStrategy(File file)
  {
    IFileComparisonStrategy result = null;
    for (Entry<FileFilter, IFileComparisonStrategy> entries : fileComparisonStrategies.entrySet())
    {
