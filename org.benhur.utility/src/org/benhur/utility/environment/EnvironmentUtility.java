...
public class EnvironmentUtility
{
  ...
  public static boolean IS_WINDOWS_XP = IS_WINDOWS && OS_NAME.equalsIgnoreCase("Windows XP")
      && OS_VERSION.equalsIgnoreCase("5.1");
  public static boolean IS_WINDOWS_VISTA = IS_WINDOWS && OS_NAME.equalsIgnoreCase("Windows Vista")
      && OS_VERSION.equalsIgnoreCase("5.3");
  public static boolean IS_WINDOWS_SEVEN = IS_WINDOWS && OS_NAME.equalsIgnoreCase("Windows Seven")
      && OS_VERSION.equalsIgnoreCase("5.4");
